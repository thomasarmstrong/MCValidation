...
os.system("python run_simtel.py --infile /home/armstrongt/Workspace/CTA/MCValidation/data/nsbscan/runlist.txt "
          " --outdir /home/armstrongt/Workspace/CTA/MCValidation/data/nsbscan "
          " --nevents File "
